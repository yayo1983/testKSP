...
urlpatterns = [
    ...
    path('list_employees/employee_detail/<int:pk>', views.detail_beneficiaries, name='detail-employees'),
    path('list_employees/update/<int:pk>', views.update_employee, name='update-employee'),
    path('list_employees/deactivate/<int:pk>', views.deactivate_employee, name='delete-employee'),
